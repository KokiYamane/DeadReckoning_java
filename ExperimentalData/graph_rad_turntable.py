...
# 角度理想値
expected = -(data[item.time]+50)*6.12%360-180
...
graph2.legend(bbox_to_anchor=(0, 0), loc="lower left", borderaxespad=0, fontsize=12)
graph3.legend(bbox_to_anchor=(0, 0), loc="lower left", borderaxespad=0, fontsize=12)
